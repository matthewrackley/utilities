...
export type GetCountryArrays = <R extends RegionCode>(region?: R) => CountriesArray | CountryArray<R>;
//___=============================>             <============================___\\
//___|| ==================== ||      MAIN TYPE      || =================== ||___\\
//___=============================>             <============================___\\
/**
...
export type CountriesArray<R extends RegionCode = RegionCode> = [
  ...
  R extends "TT" ? ["Trinidad and Tobago", "TT", "1868", "+.(...)...-....", "🇹🇹", ["Regions", "Municipalities",], { Municipalities: ["Siparia", "Sangre Grande", "Port of Spain", "Arima", "Point Fortin", "Chaguanas", "Diego Martin", "San Fernando"], Regions: ["Eastern Tobago", "Couva-Tabaquite-Talparo", "Princes Town", "Rio Claro-Mayaro", "Penal-Debe", "Sangre Grande", "San Juan-Laventille", "Tunapuna-Piarco"] }] : never,
  R extends "TV" ? ["Tuvalu", "TV", "688", "+...-.....", "🇹🇻", "Islands", ["Funafuti", "Nanumea", "Nui", "Nukufetau", "Nukulaelae", "Vaitupu"]] : never,
  R extends "UA" ? ["Ukraine (Україна)", "UA", "380", "+...(..)...-..-..", "🇺🇦", "Oblasts", ["Cherkasy", "Chernihiv", "Chernivtsi", "Dnipropetrovsk", "Donetsk", "Ivano-Frankivsk", "Kharkiv", "Kherson", "Khmelnytskyi", "Kiev", "Kirovohrad", "Luhansk", "Lviv", "Mykolaiv", "Odessa", "Poltava", "Rivne", "Sumy", "Ternopil", "Vinnytsia", "Volyn", "Zakarpattia", "Zaporizhzhia", "Zhytomyr", "Autonomous Republic of Crimea"]] : never,
...
export type CountriesData = {
  [R in RegionCode]: {
    [P in keyof Country<R> as Country<R>[P] extends never ? never : P]: Country<R>[P];
  }
};
...
export interface Country<R extends RegionCode = RegionCode> {
  name: CountryName<R>;
  regionCode: R;
  dialCode: DialingCode<R>;
  ...
  local?: ForeignLocal<R, 'Local', 'LCF' | 'LF' | 'LCN'>;
...
export interface Countries extends CountriesData, GetCountryArrays {
  [Symbol.toStringTag]: 'Countries';
  new (): Countries;
  array: CountriesArray;
  arr: MappedArray;
  prototype: Countries;
  lookup: typeof reverseLookup;
}
...
>(region: R, type: T, form: F) => ForeignLocal<R, T, F>;
