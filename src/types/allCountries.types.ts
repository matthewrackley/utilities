...
type CountryName = AllCountries[keyof AllCountries][0];
type DialCode = AllCountries[keyof AllCountries][2];
type PhoneNumberFormat = Exclude<AllCountries[keyof AllCountries][3], "" | undefined>;
type DialPriority = Exclude<AllCountries[keyof AllCountries][7], undefined>;
type AreaCodes = Exclude<AllCountries[keyof AllCountries][8], undefined>;
type Zones = Exclude<AllCountries[keyof AllCountries][5], undefined | 1>;
type ArrayOfZones = Util.ArrayUnion<AllCountries[keyof AllCountries][5]>;
type ObjectZones = Exclude<AllCountries[keyof AllCountries][5], ArrayOfZones | undefined | 1>;
type ZoneType = Exclude<AllCountries[keyof AllCountries][4], CountryFlag>;
type ZoneArray = Util.ArrayUnion<AllCountries[keyof AllCountries][4]>
type SingleZone = Exclude<Exclude<AllCountries[keyof AllCountries][4], CountryFlag>, ZoneArray>;
